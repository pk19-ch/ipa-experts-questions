...
\begin{Form}
  ...
  \makebox[\fieldlabelwidth][l]{IPA-Arbeitstitel:}\TextField[charsize=10pt, width=\dimexpr\linewidth-\fieldlabelwidth-5pt]{}\\
  \makebox[\fieldlabelwidth][l]{Kandidat*in:}\TextField[charsize=10pt, width=\dimexpr\linewidth-\fieldlabelwidth-5pt]{}\\
  \makebox[\fieldlabelwidth][l]{VF:}\TextField[charsize=10pt, width=\dimexpr\linewidth-\fieldlabelwidth-5pt]{}\\
  \makebox[\fieldlabelwidth][l]{HEX:}\TextField[charsize=10pt, width=\dimexpr\linewidth-\fieldlabelwidth-5pt]{}\\
  \makebox[\fieldlabelwidth][l]{NEX:}\TextField[charsize=10pt, width=\dimexpr\linewidth-\fieldlabelwidth-5pt]{}\\
